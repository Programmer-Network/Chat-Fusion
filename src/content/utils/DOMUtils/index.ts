...
export default class DOMUtils {
  ...
  getSelectors(): ISelectorConfig {
    ...
    const configMap: { [key: string]: ISelectorConfig } = {
      ...
      "kick.com": {
        ...
        messageAuthor: "#chatroom .chat-message-identity .chat-entry-username",
        messageAuthorBadge: "",
  ...
  getMessageText(node: Element) {
    ...
    return node.querySelector(this.selectors.messageText)?.textContent || "";
  }
  ...
  getMessageAuthor(node: Element) {
    ...
    return node.querySelector(this.selectors.messageAuthor)?.textContent || "";
  }
